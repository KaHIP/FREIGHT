...
collect="${collect} data_results/freight_cut"
...
color_jump=100		     # number of color to be jumped for better formatting
color_jumpb=100		     # number of color to be jumped for better formatting

#################### NO NEED TO CHANGE BELOW HERE ####################
source ./meta_scripts/setup_time.sh
