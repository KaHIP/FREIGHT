...
collect="data_results/freight_cut"
...
collect="${collect} data_results/patoh_cut"
...
caption="${caption},intnetl_SSArrayfennelapprosqrt_cut:FREIGHT-cut"
...
caption="${caption},intnetlpatohx2:PaToH-cut"
...
xrange_con_pp="1:8"	     # range on x axis (Map performance profile)
...
xrange_tim_pp="1:8192"        # range on x axis (running time performance profile)
...
log2_res_pp=1		     # x-axis of results performance profile in log2 scale
...
color_jump=2		     # number of color to be jumped for better formatting
color_jumpb=8		     # number of color to be jumped for better formatting

#################### NO NEED TO CHANGE BELOW HERE ####################
source ./meta_scripts/setup_cutnet.sh
