...
set ylabel "% improvement in connectivity"  font "Times,35" offset -4,0
...
#unset key
plot \
'impr_intnetlpatohx1.csv' using 'ind':'PaToH-con' title 'PaToH-con' 		with boxes linecolor rgb 'light-blue', \
'impr_intnetl_SSArrayfennelapprosqrt_con.csv' using 'ind':'FREIGHT-con' title 'FREIGHT-con' 		with boxes linecolor rgb 'brown', \
