...
#set ylabel "% instances {/Symbol \243} {/Symbol t} best partition"  font "Times,35" offset -4,0
set ylabel "% instances {/Symbol \243} {/Symbol t} best generic_metric_yaxis"  font "Times,35" offset -4,0
