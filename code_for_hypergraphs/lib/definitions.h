...
const PartitionID CUT_NET	       = std::numeric_limits<PartitionID>::max()-1;
const PartitionID COMPUTED_CUT_NET     = std::numeric_limits<PartitionID>::max()-2;
...
typedef enum {
	HMETIS_PRINT_PIN_COUNT,
        HMETIS_TO_PINSETLIST,
        HMETIS_TO_NETLIST,
	HMETIS_TO_EDGELIST,
	HMETIS_TO_MATRIXMARKET_NODE_TO_NET,
        METIS_TO_PINSETLIST_EDGE_TO_NET,
        METIS_TO_NETLIST_EDGE_TO_NET,
        METIS_TO_PINSETLIST_NODE_TO_NET,
        METIS_TO_NETLIST_NODE_TO_NET,
        METIS_TO_HMETIS_EDGE_TO_NET,
        METIS_TO_HMETIS_NODE_TO_NET,
